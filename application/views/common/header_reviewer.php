                        ...
                        <nav>
                            <ul class="nav topnav">
                                <li class="dropdown active">
                                    <a href="<?= base_url() . 'index.php/reviewerctl'; ?>">Home</a>
                                </li>
                                <li class="dropdown">
                                    <a href="#">task</a>
                                    <ul class="dropdown-menu">
                                        <li><a href="<?= base_url() . 'index.php/reviewerctl/viewAssignment'; ?>">View Requested Assignment</a></li>
                                        <li><a href="<?= base_url() . 'index.php/reviewerctl/viewAcceptedAssignment'; ?>">View Accepted Assignment</a></li>
                                        <li><a href="<?= base_url() . 'index.php/reviewerctl/viewHistoryAssignment'; ?>">View History Assignment</a></li>
                                        <li><a href="<?= base_url() . 'index.php/reviewerctl/deductFund'; ?>">Rp <?php echo $saldo ?></a></li>
