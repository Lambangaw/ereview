                            ...
                            <ul class="nav topnav">
                                ...
                                <li class="dropdown">
                                    ...
                                    <ul class="dropdown-menu">
                                        <li><a href="<?= base_url() . 'index.php/editorctl/addtask'; ?>">Add New Task</a></li>
                                        <li><a href="<?= base_url() . 'index.php/editorctl/viewtask'; ?>">View Task</a></li>
                                ...
                                <li class="dropdown">
                                    ...
                                    <ul class="dropdown-menu">
                                        ...
                                        <li><a href="#"><a href="<?php echo base_url() . 'index.php/accountctl/changeRole'; ?>"><?php echo $current_role ?></a></a>
