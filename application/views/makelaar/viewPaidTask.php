                        ...
                        <table border="1" , id="view_task">
                            ...
                            foreach ($tasks as $item) {
                                ...
                                <tr>
                                    ...
                                    <td><a href="<?php echo base_url() . 'index.php/ApplicationCtl/buktiDownload/' . $item['id_assignment'] ?>" target="_blank"><?php echo $item['bukti']; ?></a></td>
                                    <td><a href="<?php echo base_url() . 'index.php/ApplicationCtl/assignmentDownload/' . $item['id_assignment'] ?>" target="_blank"><?php echo $item['file_location']; ?></a></td>
                                    ...
                                    <td style="text-align:center">
                                        <?php if ($item['status'] == 5) { ?>
                                            <a href="<?php echo site_url('makelaarCtl/accepted/' . $item['id_task'] . '/' . $item['id_user'] . '/' . $item['id_assignment']) ?>" class="badge badge-success">accept</a>
                                            <a href="<?php echo site_url('makelaarCtl/rejected/' . $item['id_task']) ?>" class="badge badge-info">reject</a>
                                        <?php } ?>
                                    </td>
                                </tr>
                            <?php } ?>
